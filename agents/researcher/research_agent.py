...
Usage:
  python -m agents.researcher.research_agent
  python agents/researcher/research_agent.py
"""
...
from agents.researcher.market_scanner import (
    scan_all_candidates,
...
# Output paths (as per architecture spec)
TRUTH_DIR = _PROJECT_ROOT / 'logs' / 'truth'
REPORTS_DIR = _PROJECT_ROOT / 'reports' / 'research'
