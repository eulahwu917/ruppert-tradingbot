...
from agents.strategist.edge_detector import find_opportunities
from agents.trader.trader import Trader
from agents.data_scientist.logger import log_activity, log_trade, get_daily_summary, get_daily_exposure, get_computed_capital
...
_STRATEGY_EXITS_LOG = str(_PROJECT_ROOT / 'logs' / 'strategy_exits.jsonl')
    ...
    try:
        ...
        for series, spot, half_w, daily_vol, hours in SERIES_CFG:
            ...
            for m in near_price:
                ...
                from agents.trader.crypto_client import compute_composite_confidence
