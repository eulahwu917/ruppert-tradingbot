...
from agents.data_scientist.logger import log_trade, log_activity, get_daily_exposure
...
def scan_long_horizon_markets(client) -> list[dict]:
    ...
    from agents.trader.crypto_client import get_btc_signal, get_eth_signal
