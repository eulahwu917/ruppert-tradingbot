...
try:
    ...
    check("import bot.strategy", True)
except Exception as e:
    check("import bot.strategy", False, str(e))
...
secrets_config = ROOT.parent / "secrets" / "kalshi_config.json"
check("secrets/kalshi_config.json exists", secrets_config.exists())

logs_dir = ROOT / "logs"
check("logs/ directory exists", logs_dir.is_dir())
