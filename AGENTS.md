...
For complex analytical tasks (data audits, strategy analysis, multi-file code review, spec writing), always spawn sub-agents with **at least 20 minutes** (`runTimeoutSeconds: 1200`). Default 5-minute timeouts cause agents to bail mid-analysis without saving output.

Rule of thumb:
- Simple/single-file tasks: 5-10 min (300-600s)
- Data analysis, audits, spec writing: 20 min (1200s)
- Full audit loops, multi-domain analysis: 30 min (1800s)
