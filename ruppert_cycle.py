...
from agents.ruppert.data_scientist.logger import log_trade, log_activity, get_daily_exposure, get_computed_capital, send_telegram, rotate_logs, normalize_entry_price, acquire_exit_lock, release_exit_lock
...
def run_econ_prescan_mode(client, state):
    ...
    try:
        ...
        from agents.ruppert.data_scientist.logger import get_computed_capital as _get_cap_econ
